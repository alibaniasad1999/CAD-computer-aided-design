...
%2-3
p2 = x(1)*CAR_0+x(2)*CAR_1+x(3)*CAR_2+x(4)*CAR_3;
py2 = y(1)*CAR_0+y(2)*CAR_1+y(3)*CAR_2+y(4)*CAR_3;
%3-4
p3 = x(2)*CAR_0+x(3)*CAR_1+x(4)*CAR_2+x(5)*CAR_3;
py3 = y(2)*CAR_0+y(3)*CAR_1+y(4)*CAR_2+y(5)*CAR_3;
%4-5
